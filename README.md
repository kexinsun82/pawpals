# PawPals ASP.NET Project

## Overview
PawPals is a web application built using ASP.NET Core and Entity Framework that allows administrators to manage connections between members and pets. The application includes CRUD (Create, Read, Update, Delete) functionalities for pets, members, and connections.
