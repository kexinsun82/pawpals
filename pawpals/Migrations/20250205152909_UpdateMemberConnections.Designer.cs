...
namespace pawpals.Migrations
{
    ...
    [Migration("20250205152909_UpdateMemberConnections")]
    partial class UpdateMemberConnections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemberMember", b =>
                {
                    b.Property<int>("FollowersMemberId")
                        .HasColumnType("int");

                    b.Property<int>("FollowingMemberId")
                        .HasColumnType("int");

                    b.HasKey("FollowersMemberId", "FollowingMemberId");

                    b.HasIndex("FollowingMemberId");

                    b.ToTable("MemberConnections", (string)null);
                });
            ...
            modelBuilder.Entity("MemberMember", b =>
                {
                    b.HasOne("pawpals.Models.Member", null)
                        .WithMany()
                        .HasForeignKey("FollowersMemberId")
